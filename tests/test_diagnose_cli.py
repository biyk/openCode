...
class TestMain:
    ...
    def test_launch_detached(self, tmp_path, mocker):
        popen = mocker.patch("lib.diagnose_cli.subprocess.Popen")
        assert main.__module__ == "lib.diagnose_cli"
    ...
    def test_busy_run(self, tmp_path, mocker, capsys):
        ...
        voiced = []
        mocker.patch("lib.diagnose_supervisor.TextToSpeech")
        mocker.patch(
            "lib.diagnose_supervisor.TranscriptionOutput.print_info",
