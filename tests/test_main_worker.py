...
class TestTranscriptionWorkerInit:
    ...
    def test_init_sets_up_components(self, mocker):
        ...
        mocker.patch("lib.transcription_worker.TextToSpeech")
        mock_provider = mocker.patch("lib.transcription_worker._provider_manager")
        mock_provider.get_client.return_value = "LLM"
        matcher = lib.transcription_worker.CommandMatcher.return_value
        matcher.get_llm_config.return_value = {"history_limit": 5}
        matcher.get_intent_config.return_value = {}

        worker = lib.transcription_worker.TranscriptionWorker(lang_code="ru", device_name="dev")
    ...
    def test_init_mini_disabled_by_default(self, mocker):
        ...
        mocker.patch("lib.transcription_worker.Logger")
        mocker.patch("lib.transcription_worker.TextToSpeech")
        mocker.patch("lib.transcription_worker._provider_manager")
        matcher = lib.transcription_worker.CommandMatcher.return_value
        matcher.get_llm_config.return_value = {}
        matcher.get_intent_config.return_value = {}
