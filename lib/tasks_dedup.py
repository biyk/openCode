...
(любой выбор не none), но решение даёт только подтвержающий парный
...
# Порог подтвержающего парного вопроса: дубликаты дают ~0.25-0.9,
# чужие пары — <0.1.
DUP_THRESHOLD = 0.15
# Вопрос по пачке — только кандидат: годится любой выбор не none
# (уверенность на 15 вариантах шуменная, ~0.02-0.9).
BATCH_THRESHOLD = 0.0
