...
│   └── wake_event.py  # Команда «я проснулся»: находит ближайшее начавшееся событие «СОН» и фиксирует его завершение текущим временем, затем засчитывает по ✅ задачу «Пробуждение» (done.md); CLI python -m lib.wake_event
├── prompts/
